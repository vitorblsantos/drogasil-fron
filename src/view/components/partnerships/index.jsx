...
const Partnerships = () =>{
    return(
        <List>
            <li><a href="./"><img src={Drogaraia} alt=""/></a></li>
            <li><a href="./"><img src={Drogasil} alt=""/></a></li>
            <li><a href="./"><img src={Farmasil} alt=""/></a></li>
            <li><a href="./"><img src={Univers} alt=""/></a></li>
            <li><a href="./"><img src={xbio} alt=""/></a></li>
        </List>
    )
}
